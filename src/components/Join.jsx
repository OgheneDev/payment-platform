...
const Join = () => {
  return (
    ...
    <h1 className='text-2xl md:text-4xl font-light mb-[30px] md:mb-[80px] text-center'>Join 200M active PayPal accounts worldwide.</h1>

      <div className='flex flex-col md:flex-row md:px-[50px] md:gap-[30px] gap-[25px]'>
